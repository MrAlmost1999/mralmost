...
public class CommentService {
    ...
    public void insertSelective(Comment comment, User commentator) {
        ...
        if (comment.getType() == CommentTypeEnum.COMMENT.getType()) {
            ...
            //创建通知
            createNotify(comment, dbComment.getCommentator(), commentator.getUsername(), question.getTitle(), NotificationEnum.REPLY_COMMENT, question.getId());
        } else {
            //回复问题
     ...
     * @param comment          评论
     * @param receiver         通知人
     * @param notifierName     发通知人的昵称
     * @param outerTitle       通知内容
     * @param notificationEnum 通知枚举
     * @param outerId          question或者comment的id
     */
    private void createNotify(Comment comment, Long receiver, String notifierName, String outerTitle, NotificationEnum notificationEnum, Long outerId) {
        ...
        notification.setCreateTime(DateFormat.dateFormat(new Date()));
